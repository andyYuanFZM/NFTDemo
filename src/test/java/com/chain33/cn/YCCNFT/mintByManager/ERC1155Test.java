package com.chain33.cn.YCCNFT.mintByManager;
...
public class ERC1155Test {
	...
	// 合约部署人（管理员）地址和私钥,地址下需要有YCC来缴纳手续费
	// 生成方式参考下面BlockChainTest.java中的createAccountYCC方法，私钥和地址一一对应
	String managerAddress = "0xace8f257f957aaab716ff3d444dbff470ce0cab9";
	String managerPrivateKey = "0x42c87f281b2cd101a5dc54b85fa6b753579be3f5770f1cf9b166188bf0c41b72";
...
//  String managerPrivateKey = "替换成自己的私钥，用下面createAccount方法生成,注意私钥千万不能泄漏";
	...
	String withholdAddress = "0x2112a4f44544e63d434cbfee5bbd6f942a5a42dd";
